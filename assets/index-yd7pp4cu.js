    ...
    function Si(e, t, n, r, i, a) {
      ...
      if (((r = e), typeof e == `function`)) yi(e) && (o = 1);
        ...
        a: switch (e) {
          ...
          case te:
            return (
              (e = vi(13, n, t, i)), (e.elementType = te), (e.lanes = a), e
            );
          case ne:
            return (
              (e = vi(19, n, t, i)), (e.elementType = ne), (e.lanes = a), e
            );
          default:
...
`
  ...
  p = () =>
    (0, f.jsx)(`header`, {
      ...
      children: (0, f.jsxs)(`nav`, {
        className: `w-full h-full flex flex-row-reverse box-border justify-end relative`,
        children: [
          (0, f.jsx)(`img`, {
            src: `../images/logo.png`,
            alt: `logo`,
            className: `absolute top-5/12 left-[71%]`,
          }),
          (0, f.jsxs)(`ul`, {
            className: `w-[70%] h-full pt-5 box-border list-none flex gap-7 items-center flex-row-reverse`,
            children: [
              [
                ...
                { title: `وبلاگ`, link: `#`, dropdown: [`مجله گلستان`] },
                { title: `قرعه‌ کشی`, link: `#` },
                { title: `استخدام`, link: `#` },
                {
                  title: `تماس با ما`,
                ...
                (0, f.jsxs)(
                  `li`,
                  {
                    ...
                    children: [
                      ...
                      e.dropdown &&
                        (0, f.jsx)(`div`, {
                          className: `invisible group-hover:visible duration-300 w-fit bg-[#2d2d2d] py-5 absolute top-[75%] duration-500 box-border p-3.5`,
                          children: (0, f.jsx)(`ul`, {
                            className: `w-fit list-none flex flex-col items-start justify-start gap-5`,
              ...
              (0, f.jsx)(`li`, {
                className: `w-fit h-5 flex justify-center items-center`,
                children: (0, f.jsx)(`a`, {
                  className: `font-sans text-[#afb2b4] transition-all duration-300 hover:text-white`,
                  children: `EN`,
                }),
              }),
            ],
  ...
  m = () =>
    (0, f.jsxs)(`div`, {
      className: `w-full h-[600px] bg-[linear-gradient(180deg,_#fbfbfb,_#d2d2d2)] flex justify-start `,
      children: [
        (0, f.jsx)(`div`, {
          className: `w-2/5 h-full pt-7 flex justify-end items-center pr-2.5 box-border overflow-hidden z-10 animate-[slide-in_1s_ease_0.5s_1_normal_forwards]`,
        ...
        (0, f.jsxs)(`div`, {
          className: `w-[41%] h-full flex justify-center box-border items-end flex-col gap-5 animate-[slide-in_1s_ease_0.5s_1_normal_forwards]`,
          children: [
            (0, f.jsxs)(`div`, {
              className: `w-[70%] flex flex-col justify-end items-start pt-17.5 box-border`,
              children: [
                (0, f.jsx)(`div`, {
                  className: `w-full font-[iranSans] text-[#ed1c24] text-[30px] font-normal text-right mb-2.5 box-border pb-3`,
                  children: `قرعه‌کشی مصرف‌کنندگان گلستان`,
                }),
                (0, f.jsx)(`div`, {
                  className: `w-full font-[iranSans] text-[#002021] text-[20px]  font-normal text-right`,
                  children: `قرعه‌کشی دوره‌ای مصرف‌کنندگان چای گلستان`,
                }),
              ],
            }),
            (0, f.jsx)(`div`, {
              ...
              children: `ههر یک از مصرف‌کنندگان محصولات چای و چای کیسه‌ای گلستان می‌توانند با ارسال کد قرعه‌کشی روی بسته به شماره 30007405 در قرعه کشی‌های دوره‌ای گلستان شرکت کنند. نگهداری از بسته‌بندی محصول برای اهدای جایزه الزامی است.`,
            }),
            (0, f.jsx)(`div`, {
              className: `w-full flex justify-end`,
              children: (0, f.jsx)(`button`, {
                className: `flex justify-center items-center border-[0.8px] border-solid border-[#c8c8c8] rounded-lg py-3 px-6 box-border font-[iranSans] bg-white text-[#7c7d7e] text-[15px] font-normal cursor-pointer transition-all duration-500 hover:bg-[#ed1c24] hover:text-white`,
  ...
  h = () =>
    (0, f.jsx)(`div`, {
      className: `w-full border-solid border-b-[0.2px]  border-[#797979] p-2.5 box-border `,
    }),
  g = () =>
    (0, f.jsxs)(`div`, {
      className: `w-full h-[100vh] flex justify-start flex-col items-center pt-[75px] select-none`,
      children: [
        (0, f.jsxs)(`div`, {
          className: `w-[45%] h-full flex flex-col justify-center p-2.5 box-border animate-[slide-right_1s_ease_0.5ms_1_normal_forwards] `,
          children: [
            (0, f.jsx)(`div`, {
              className: `font-[iranSans] text-xl font-bold text-right pb-3 box-border text-[#ed1c24]`,
              children: `معرفی گلستان`,
            }),
            (0, f.jsxs)(`div`, {
              dir: `rtl`,
              ...
              children: [
                (0, f.jsxs)(`div`, {
                  className: `font-[iranSans] font-normal text-base leading-10 text-justify text-[#818588]`,
                  children: [
                    `آنچه که امروز با نام مجموعه`,
                    (0, f.jsx)(`h3`, {
                      className: `font-[iranSans] inline-block font-normal text-base leading-10 text-justify text-[#ed1c24] pl-1 box-border`,
                      children: `گلستان`,
                    }),
                    `می‌شناسیم در سال 1329 بنیان نهاده شد. زمانی که شرکت گلستان فعالیت خود را با بسته‌بندی و توزیع چای پاکتی آغاز کرد. با گذر زمان و رشد اقتصاد کشور، نهال «گلستان» به تدریج تقویت شد و شاخ و برگ گرفت. فعالیت‌های «گلستان» با تهیه، تولید و بسته‌بندی بهترین محصولات غذایی گسترش پیدا کرد.`,
                    (0, f.jsx)(`h3`, {
                      className: `font-[iranSans] inline-block font-normal text-base leading-10 text-justify text-[#ed1c24] pl-1 box-border`,
                      children: `گلستان`,
                    }),
                    `پس از سال‌ها تلاش همچنان می‌کوشد تا به کمک تجربه‌های اندوخته شده در این سال‌ها کالاهایی قابل اعتماد و با کیفیت تولید نماید.`,
                  ],
                }),
                (0, f.jsxs)(`div`, {
                  className: `font-[iranSans] font-normal text-base leading-10 text-justify text-[#818588]`,
            ...
            (0, f.jsx)(`div`, {
              ...
              children: (0, f.jsxs)(`div`, {
                ...
                children: [
                  (0, f.jsx)(`h3`, {
                    className: `font-[iranSans] inline-block font-normal text-base leading-10 text-justify text-[#ed1c24] pl-1 box-border`,
                    children: `نام تجاری گلستان`,
                  }),
                  `قدمتی به اندازه عمر شرکت گلستان دارد. گلستان ممتازترین محصولات خود را با این نام تجاری عرضه می‌کند. مصرف‌کنندگان محصولات گلستان همواره از این نام تجاری خاطره محصولاتی ممتاز و منحصر بفرد دارند و با اطمینان از نهایت کیفیت این نام تجاری حمایت می‌کنند.`,
                ],
              }),
            }),
          ],
  ...
  _ = () =>
    (0, f.jsx)(`div`, {
      ...
      children: (0, f.jsxs)(`div`, {
        className: `w-[55%] h-[35vh] grid grid-cols-4 grid-rows-1 gap-x-[10px] gap-y-0`,
        children: [
          (0, f.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, f.jsx)(`div`, {
                className: `py-[15px] box-border font-[iranSans] text-base text-center font-extralight text-[#7c7d7e]`,
                children: `مشتریان گلستان`,
              }),
              (0, f.jsx)(`div`, {
                className: `w-[97%] border-[0.8px] border-solid border-[rgb(230,229,229)] `,
              }),
            ],
          }),
          (0, f.jsxs)(`div`, {
            ...
            children: [
              (0, f.jsx)(`img`, {
                src: `../images/features/products.png`,
                alt: `products`,
              }),
              (0, f.jsx)(`div`, {
                className: `py-[15px] box-border font-[iranSans] text-base text-center font-extralight text-[#7c7d7e]`,
          ...
          (0, f.jsxs)(`div`, {
            ...
            children: [
              (0, f.jsx)(`img`, {
                src: `../images/features/market.png`,
                alt: `market`,
              }),
              (0, f.jsx)(`div`, {
                className: `py-[15px] box-border font-[iranSans] text-base text-center font-extralight text-[#7c7d7e]`,
              ...
              children: [
                (0, f.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, f.jsxs)(`div`, {
                      className: `w-fit bg-[#ed1c24] flex flex-col justify-center items-end py-[16.5px] pr-8 pl-30 box-border absolute top-[81%] left-[60%] gap-1.5`,
                      children: [
                        (0, f.jsx)(`div`, {
                          className: `font-[iranSans] text-3xl font-extralight text-white`,
                          children: e.title,
                        }),
                        (0, f.jsx)(`div`, {
                          className: `font-[iranSans] text-base font-normal text-white`,
                ...
                (0, f.jsx)(`div`, {
                  className: `w-full border-solid border-b-[1px]  border-[#d2d2d2] p-2.5 box-border `,
                }),
                (0, f.jsxs)(`div`, {
                  className: `pt-7.5 box-border w-[46%] flex flex-col justify-center items-center gap-2.5 `,
                  children: [
                    (0, f.jsx)(`div`, {
                      className: `w-full font-[iranSans] font-bold text-[20px] leading-10 text-right text-[#ed1c24] mb-1.5`,
                      children: e.productTitle,
                    }),
                    (0, f.jsx)(`div`, {
                      className: ` font-[iranSans] font-normal text-[15px] leading-10 text-justify text-[#818588]`,
                      dir: `rtl`,
                      children: e.ProductText,
                    }),
                    (0, f.jsxs)(`div`, {
                      className: `w-full pt-10 box-border flex justify-end gap-2.5 items-center`,
                      children: [
                        e.buttonText.btn1 &&
                          (0, f.jsx)(`button`, {
                            className: `flex justify-center items-center border-[0.8px] border-solid border-[#c8c8c8] rounded-lg py-2 px-3.5 box-border font-[iranSans] bg-white text-[#7c7d7e] text-[15px] font-normal cursor-pointer transition-all duration-500 hover:bg-[#ed1c24] hover:text-white`,
                            children: e.buttonText.btn1,
                          }),
                        e.buttonText.btn2 &&
                          (0, f.jsx)(`button`, {
                            className: `flex justify-center items-center border-[0.8px] border-solid border-[#c8c8c8] rounded-lg py-2 px-3.5 box-border font-[iranSans] bg-white text-[#7c7d7e] text-[15px] font-normal cursor-pointer transition-all duration-500 hover:bg-[#ed1c24] hover:text-white`,
                            children: e.buttonText.btn2,
                          }),
                      ],
                    }),
                  ],
  ...
  y = () =>
    (0, f.jsx)(`div`, {
      className: `w-full pt-5 box-border min-h-[250px] bg-fixed bg-center bg-contain bg-no-repeat bg-[url('../images/background.png')]`,
    }),
  b = () =>
    (0, f.jsx)(`div`, {
      children: (0, f.jsx)(`div`, {
        className: `w-full h-[115vh] flex justify-center items-center pt-10 box-border`,
        children: (0, f.jsxs)(`div`, {
          className: `w-full h-full flex flex-col`,
          children: [
            (0, f.jsx)(`div`, {
              className: `w-[82%] font-[iranSans] text-xl font-bold text-right pb-10 box-border text-[#ed1c24]`,
              children: `مجله گلستان`,
            }),
            (0, f.jsx)(`div`, {
              className: `w-full h-full bg-[#cde4b0] flex justify-center items-center`,
              children: (0, f.jsx)(`div`, {
                className: `w-fit grid grid-cols-3 grid-rows-1 gap-x-[10px] gap-y-0`,
                children: [
                  {
                    imgSrc: `../images/recepie/food.jpg`,
                    titleRecepie: `چیلاکیله`,
                    descriptionRecepie: `احتمالا نام چیلا کیله را نشنیده باشید ولی اگر یکبار این غذای فوق‌العاده خوشمزه را تهیه کنید و نوش جان کنید جزئی جدانشدنی از فهرست`,
                  },
                  {
                    imgSrc: `../images/recepie/food2.jpg`,
                    titleRecepie: `سوپ مکزیکی`,
                    descriptionRecepie: `گوشت بوقلمون را در یک ماهیتابه بزرگ ریخته، آب روی آن بریزید تا روی آن را بپوشاند و به مدت نیم ساعت آن را بپزید. گوشت را از مایع آن بیرون آورده…`,
                  },
                  {
                    imgSrc: `../images/recepie/food3.jpg`,
                    titleRecepie: `ماکارونی با سبزیجات`,
                    descriptionRecepie: `ابتدا ماکارانی‌ها را در ظرفی‌ به‌ همراه‌ آب‌، روغن‌ مایع‌ و نمک‌ می‌ریزیم‌ تا کمی‌ بپزد. در این‌ حین‌ پیازها را خرد کرده‌ و روی‌ روغن‌ تفت‌ می‌دهیم‌ تا طلایی‌ شود…`,
                  },
                ].map((e, t) =>
                  (0, f.jsxs)(
                    `div`,
                    {
                      ...
                      children: [
                        (0, f.jsx)(`div`, {
                          className: `w-full h-[320px] pb-5 box-border`,
                          children: (0, f.jsx)(`img`, {
                            src: e.imgSrc,
                            alt: `food`,
                        ...
                        (0, f.jsx)(`div`, {
                          className: `w-full text-right px-5 pb-5 box-border font-[iranSans] text-xl font-extralight text-[#ed1c24]`,
                          children: e.titleRecepie,
                        }),
                        (0, f.jsx)(`div`, {
                          dir: `rtl`,
                          className: `w-full text-right px-5 box-border font-[iranSans] pb-5 text-sm leading-8 font-extralight text-[#7c7d7e]`,
                          children: e.descriptionRecepie,
                        }),
                        (0, f.jsx)(`div`, {
                          className: `w-full flex justify-end px-[22px] pb-[20px] pt-0 box-border`,
                          children: (0, f.jsx)(`button`, {
                            className: `flex justify-center items-center border border-[#c8c8c8] border-[0.8px] text-[#7c7d7e] rounded-lg py-2 px-[14px] box-border no-underline font-[iranSans] hover:bg-[#ed1c24] hover:text-white`,
                            children: `ادامه مطالب`,
                          }),
                        }),
                      ],
                    },
  ...
  x = () =>
    (0, f.jsx)(`div`, {
      className: `w-full h-[75vh] flex justify-center items-center py-10`,
      children: (0, f.jsx)(`div`, {
        className: `w-[65%] grid grid-cols-3 gap-x-[15px]`,
        children: [
          {
            vidSrc: `../videos/products.mp4`,
            title: `برنج گلستان`,
          ...
          {
            vidSrc: `../videos/noodle-salad.mp4`,
            title: `سالاد نودل`,
          ...
          (0, f.jsxs)(
            `div`,
            {
              ...
              children: [
                ...
                (0, f.jsx)(`div`, {
                  className: `w-full px-5 text-right font-iran text-[17px] font-[iranSans] font-bold text-red-600`,
                  children: e.title,
                }),
                (0, f.jsx)(`div`, {
                  className: `w-full px-5 text-justify text-right leading-8 text-[#7c7d7e] font-[iranSans] text-sm font-light`,
                  children: e.description,
                }),
                (0, f.jsx)(`div`, {
                  className: `w-full flex justify-end px-[22px] pb-5`,
                  children: (0, f.jsx)(`button`, {
                    className: `flex justify-center items-center border border-[#c8c8c8] font-[iranSans] rounded-lg py-2 px-[14px] bg-white text-[#7c7d7e] text-[15px] font-normal cursor-pointer transition-all duration-500 hover:bg-red-600 hover:text-white`,
                    children: e.btn,
                  }),
                }),
              ],
  ...
  ee = () =>
    (0, f.jsxs)(`div`, {
      className: `w-full h-[600px] bg-[#105153] flex flex-col justify-center items-center border-b-[21px] border-[#e9d69f] relative`,
      children: [
        (0, f.jsx)(`div`, {
          className: `text-[#d5ece1] font-[IranSans] text-[18px] font-light`,
        }),
        (0, f.jsx)(`div`, {
          className: `w-full border-b border-[#0b6568] py-[10px] box-border`,
        }),
        (0, f.jsxs)(`div`, {
          className: `flex items-center justify-center gap-[5px] text-[#009da2] font-[IranSans] text-[30px] font-normal`,
          children: [
            `Golestan`,
            (0, f.jsx)(`h6`, {
              className: `text-[#00d8df] font-[IranSans] font-normal`,
              children: `Social Responsibility`,
            }),
          ],
        }),
        (0, f.jsx)(`div`, {
          className: `text-[#bcbec0] font-[IranSans] text-[17px] font-light pb-5 box-border`,
          children: `Mahdi Hospital`,
        }),
        (0, f.jsx)(`div`, {
          className: `w-[395px] h-[344px] absolute top-[60%]`,
          children: (0, f.jsx)(`img`, {
  ...
  S = () =>
    (0, f.jsx)(`div`, {
      className: `w-full flex flex-col justify-start items-center pt-[100px]`,
      children: (0, f.jsxs)(`div`, {
        className: `w-[46%] flex flex-col justify-center p-[10px] box-border`,
        children: [
          (0, f.jsx)(`div`, {
            className: `font-[IranSans] text-[20px] font-bold text-red-600 text-right mb-[5px]`,
            children: `مسئوليت‌های اجتماعی گلستان`,
          }),
          (0, f.jsxs)(`div`, {
            className: `w-full h-full flex flex-col justify-start items-center  gap-8`,
            children: [
              (0, f.jsxs)(`div`, {
                className: `font-[IranSans] font-normal text-[16px] leading-[2.5] text-justify  text-[#818588]`,
                dir: `rtl`,
                children: [
                  `آنچه که امروز با نام مجموعه كسب‌وكارها اجزای قدرتمند جامعه به شمار می‌آیند و موفق‌ترین، قابل‌احترام‌ترین و مطلوب‌ترین كسب‌وكارها آنهایی هستند كه كاری فراتر از درآمدزایی ایجاد كنند؛‌ آنهایی كه آمده‌اند تا از تجربه و امکاناتشان برای حل مشكلات جامعه و محیط زندگی خود استفاده كنند.`,
                  (0, f.jsx)(`h3`, {
                    className: `inline-block font-semibold text-[16px] text-red-600 pl-[2px]`,
                    children: `گلستان`,
                  }),
              ...
              (0, f.jsx)(`div`, {
                className: `w-full flex justify-end px-[22px] pb-5`,
                children: (0, f.jsx)(`button`, {
                  className: `flex justify-center items-center border border-[#c8c8c8] rounded-lg py-2 px-[14px] bg-white text-[#7c7d7e] text-[15px] font-normal font-[IranSans] cursor-pointer transition-all duration-500 hover:bg-red-600 hover:text-white`,
                  children: `اطلاعات بیشتر`,
                }),
              }),
            ],
  ...
  C = () =>
    (0, f.jsx)(`div`, {
      className: `w-full h-[15vh] bg-[#eeefef] flex justify-center items-center gap-[2px] border-b-[24px] border-[#ed1c24]`,
      children: [
        {
          name: `golestan`,
          gray: `../images/social-media/gl.png`,
          color: `../images/social-media/gl-color.png`,
        },
        {
          name: `aparat`,
          gray: `../images/social-media/aparat.png`,
          color: `../images/social-media/aparat-color.png`,
        },
        {
          name: `telegram`,
          gray: `../images/social-media/tele.png`,
          color: `../images/social-media/tele-color.png`,
        },
        {
          name: `instagram`,
          gray: `../images/social-media/insta.png`,
          color: `../images/social-media/insta-color.png`,
        },
        {
          name: `linkedin`,
          gray: `../images/social-media/linkdin.png`,
          color: `../images/social-media/linkdin-colorful.png`,
        },
        {
          name: `facebook`,
          gray: `../images/social-media/fb.png`,
          color: `../images/social-media/fb-color.png`,
        },
      ].map((e, t) =>
        (0, f.jsxs)(
          `div`,
  ...
  te = () =>
    (0, f.jsx)(`footer`, {
      className: `w-full h-[70vh] bg-fixed  bg-[url('../images/footer/footerBg.png')]`,
      children: (0, f.jsxs)(`div`, {
        className: `w-full h-full flex flex-col justify-evenly items-center`,
        children: [
          (0, f.jsx)(`div`, {
            className: `w-[43%] h-[75%] flex justify-between items-center`,
            children: [
              {
                title: `حبوبات گلستان`,
                image: `../images/footer/footer1.png`,
                items: [
                  `لوبیا قرمز ممتاز`,
                  `لوبیا چیتی گلستان`,
                  `عدس کانادایی`,
              ...
              {
                title: `ادویه گلستان`,
                image: `../images/footer/footer2.png`,
                items: [
                  `زعفران ممتاز خراسان`,
                  `ادویه کاری`,
                  `ادویه ماست و خیار`,
              ...
              {
                title: `تی بگ گلستان`,
                image: `../images/footer/footer3.png`,
                items: [
                  `تی بگ بلک لاین`,
                  `تی بگ ارل گری`,
                  `دمنوش نعنا`,
              ...
              {
                title: `چای گلستان`,
                image: `../images/footer/footer4.png`,
                items: [
                  `چای ممتاز هندوستان`,
                  `چای ممتاز ارل گری`,
                  `چای سیلان عطری`,
              ...
              (0, f.jsxs)(
                `div`,
                {
                  ...
                  children: [
                    ...
                    (0, f.jsx)(`div`, {
                      className: `w-full text-center font-[IranSans] text-[16px] font-light text-white py-[10px] border-t border-b border-[#b4b4b4]`,
                      children: e.title,
                    }),
                    (0, f.jsx)(`div`, {
                      className: `w-full`,
          ...
          (0, f.jsxs)(`div`, {
            className: `w-[40%] h-[25%] flex flex-col justify-center items-center`,
            children: [
              (0, f.jsx)(`div`, {
                className: `text-[#9f9f9f] font-Lato text-[15px] font-normal`,
                children: `All Right Reserved Golestan Company 2022-2025`,
              }),
              (0, f.jsx)(`div`, {
                className: `text-[#7b7b7b] font-Lato text-[14px] font-normal`,
                children: `Design By: Golestan Studio`,
              }),
            ],
          }),
        ],
